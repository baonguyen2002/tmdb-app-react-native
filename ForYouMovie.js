  ...
  return type === "genre" ? (
    <>
      {localFavMovieGenreList && localFavMovieGenreList.length > 0 ? (
          ...
          movieListBasedOnFavMovieGenre.length > 0 ? (
            <>
              <FlatList
                ...
                ListFooterComponent={() => {
                  return movieListBasedOnFavMovieGenre.length <= 5 ? null : (
                    <>
                      <TouchableOpacity
            ...
            <View className="flex items-center justify-center w-full h-full">
              <Text className="text-2xl font-bold text-center">
                Whoops, Looks like no movies match your criteria.
              </Text>
              <View>
                <Text className="text-2xl font-bold text-center">
        ...
        <View className="flex items-center justify-center w-full h-full">
          <Text className="text-2xl font-bold text-center">
            Whoops, looks like you have not set any genre as your favorites yet.
            Modify it in the Settings to see changes!
          </Text>
          <View>
            <Text className="text-2xl font-bold text-center">
              Or you can visit Popular Movies for some suggestions!
    ...
    <>
      {localFavActorList && localFavActorList.length > 0 ? (
        <>
          ...
          {movieListBasedOnFavActor && movieListBasedOnFavActor.length > 0 ? (
            <FlatList
              ...
              keyExtractor={(item) => item.id}
              ListFooterComponent={() => {
                return movieListBasedOnFavActor.length <= 5 ? null : (
                  <>
                    <TouchableOpacity
                      className="w-[70%] bg-lime-300 flex-row items-center h-12 self-center justify-center border-2 border-fuchsia-400 rounded-lg"
                      onPress={() => {
        ...
        <View className="flex items-center justify-center w-full h-full">
          <Text className="text-2xl font-bold text-center">
            Whoops, looks like you have not set any actor as your favorites yet.
            Like some people to see changes!
          </Text>
          <View>
            <Text className="text-2xl font-bold text-center">
              Or you can visit Popular Movies for some suggestions!
